...
import Idea from "./ideaGuest/idea-guest.jsx";
  ...
  const arrProduct = [
    {
      ...
      price: 690490000,
      des:
        "Đích đến mỗi cuộc hành trình là một bầu trời trong xanh, niềm đam mê phiêu lưu" +
        " khám phá những miền đất mới luôn là sự khao khát và là động lực để họ tiến bước, " +
        " để rồi cuối mỗi chặng hành trình họ có thể ngồi tận hưởng vẻ đẹp của một bầu trời trong xanh trước mắt họ." +
        " Đó là lý do chúng tôi trang bị chiếc Africa Twin Adventure Sport với những công nghệ và tính năng tối tân nhất," +
        " sẵn sàng cùng bạn khám phá thế giới.",
    ...
    },
    {
      ...
      price: 42090000,
      des:
        "Xứng danh mẫu xe tay ga thể thao tầm trung hàng đầu trong suốt hơn một thập kỷ qua," +
        " AIR BLADE hoàn toàn mới nay được nâng cấp động cơ eSP+ 4 van độc quyền, tiên tiến nhất giúp mang trong mình mãnh lực tiên phong.",
      imgDetail: [Ab1, Ab2, Ab3, Ab4],
      imgLibary: [Ab5, Ab6, Ab7, Ab8],
      thongSo: {
        khoiluong: "Air Blade 125: 113 kg - Air Blade 160: 114 kg",
        dairongcao:
          "Air Blade 125:  1.887mm x  687m x 1.092 mm   Air Blade 160: 1.890 x 686 x 1.116 mm",
    ...
    },
    {
      ...
      price: 46160000,
      des:
        "Hãy tự tin tạo những cú kích để vút xa và tạo dấu ấn riêng biệt cùng Honda WINNER X mới" +
        " Đánh dấu sự chuyển mình mạnh mẽ hướng tới hình ảnh một mẫu xe thể thao hàng đầu tại Việt Nam" +
        " trang bị hiện đại, tối tân, WINNER X mới sẽ cùng các tay lái bứt tốc trên mọi hành trình khám phá.",
    ...
    },
    {
      ...
      price: 51690000,
      des:
        "Yamaha Motor Việt Nam vừa ra mắt phiên bản Exciter 155 VVA. Exciter 155 VVA được nâng cấp và thay đổi với nhiều chi tiết" +
        " hoàn toàn mới dựa trên các công nghệ đang được áp dụng trên siêu xe thể thao YZF-R1," +
        " nhưng vẫn đảm bảo được tính ổn định và linh hoạt của 1 chiếc xe thể thao phân khối nhỏ.",
    ...
    },
    {
      ...
      price: 21700000,
      des:
        "Yamaha Sirius là mẫu xe số bền bỉ đã có mặt tại thị trường Việt Nam từ hơn 20 năm trước." +
        " Cho đến nay, dòng xe này đã được cải tiến đáng kể về thiết kế và động cơ.",
    ...
    },
    {
      ...
      price: 70000000,
      des:
        "Yamaha R15 2022 là một mẫu sportbike được đầu tư từ ngoại hình đến các trang bị hiện đại," +
        " đảm bảo làm hài lòng tất cả những ai đam mê tốc độ.",
    ...
    },
    {
      ...
      price: 1050000000,
      des:
        "ĐƯỜNG ĐUA LÀ SÂN CHƠI CỦA BẠN Nơi bạn sống thực với đam mê CBR1000RR-R Fireblade SP được trang bị hệ thống giảm xóc" +
        " Smart Electronic Control (S-EC) thế hệ 2 và cụm phanh Brembo Stylema trên phanh trước. Với khả năng vận hành vượt trội," +
        " CBR1000RR-R Fireblade SP là món quà đắt giá nhất của Honda dành tặng cho các tín đồ tốc độ",
      ...
      thongSo: {
        ...
        Momentcucdai: "8,65 Nm/5.500 vòng/phút",
        Dungtichnhotmay:
          "2,8 lít (sau khi xả nhớt) - 3,0 lít (sau khi xả nhớt và thay lọc dầu)",
        Hopso: "6 cấp",
    ...
    <div className="App">
      ...
      <div className="margin">
        <Routes>
          ...
          <Route
            path="/PageProduct"
            element={<PageProduct arrProduct={arrProduct} />}
          />
          <Route
            path="/Detail/:id"
            element={<Detail arrProduct={arrProduct} />}
          />
