...
const Detail = (props) => {
    ...
    return(
        <div className="Detail-all">
            <div className="link">
               <Link  to="/" className="link-name">Trang chủ</Link>
               <IoIosArrowForward></IoIosArrowForward>
               <Link  to="/Pageproduct" className="link-name">Sản Phẩm</Link>
           </div>
                    ...
                    <div className="Detail-container">
                       ...
                       <div className="table-container">
                           ...
                           <div className="table-item">
                               ...
                               <div className="infor">{item.thongSo.Khoangcachtrucbanhxe}</div>
                           </div>
                           <div className="table-item table-gray">
                           ...
                           <div className="table-item">
                               ...
                               <div className="infor">{item.thongSo.Kichcoloptruocsau}</div>
                           </div>
                           <div className="table-item table-gray">
                               <div className="table-title">Mức tiêu thụ nhiên liệu</div>
                               <div className="infor">{item.thongSo.Muctieuthunhienlieu}</div>
                           </div>
                           <div className="table-item">
